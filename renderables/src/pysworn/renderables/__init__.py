...
class RenderableKeyEnum(enum.Enum):
    ...
    ASSET_ABILITY_MOVE_CONDITION = "asset.ability.move.condition"
    ASSET_ABILITY_MOVE_OUTCOME = "asset.ability.move.outcome"
    ...
    RULESETS = "rulesets"
    #
    ANCIENT_WONDERS = "ancient_wonders"
    CLASSIC = "classic"
    DELVE = "delve"
    FE_RUNNERS = "fe_runners"
    IRONSMITH = "ironsmith"
    LODESTAR = "lodestar"
