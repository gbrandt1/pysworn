...
class Visitor[T]:
    ...
    def visit(self, obj: T) -> None:
        """Visit an object."""
        method = "visit_" + obj.__class__.__name__
        visitor = getattr(self, method, self.unknown_visit)
        visitor(obj)

    def depart(self, obj: T) -> None:
        """Depart an object."""
        method = "depart_" + obj.__class__.__name__
        visitor = getattr(self, method, self.unknown_departure)
        visitor(obj)

    def unknown_visit(self, obj: T) -> None:
        """
        ...
        raise NotImplementedError(
            ...
            % (self.__class__, obj.__class__.__name__)
        )
