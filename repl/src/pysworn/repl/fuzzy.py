...
adopted from Textual by Will McGugan

https://github.com/Textualize/textual/blob/main/src/textual/fuzzy.py

- remove dependencies on Textual
- use rich
...
if __name__ == "__main__":
    ...
    # print(fuzzy_search.match("foo.bar", "foo/egg.bar"))
    matcher = Matcher("foo.bar", case_sensitive=False)
    print(matcher.highlight("foo/egg.bar"))
